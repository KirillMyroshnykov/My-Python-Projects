# Правила игры:
# 1. Каждый игрок вытягивает из колоды по карте.
# 2. У кого карта старше - тот забирает обе карты себе.
# 3. Если две карты одинакового достоинства - побеждает тот, у кого старшая масть (Старшинство мастей по возрастанию: пики, трефы, бубны, черви).
# 4. Побеждает в игре тот, у кого оказывается вся колода.
